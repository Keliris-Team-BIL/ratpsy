function clpsEvent = gk_pyControl_subtract_events(event, subevent)
% USAGE: clpsEvent = gk_pyControl_subtract_events(event, subevent)
%
% INPUT:
...
%
% OUTPUT:
% - clpsEvent       : the event structure of the subtracted events
%
%
% v1.0 GAK 4 Mar 2020

[useTrials,IA]=setdiff(event.trialNum,subevent.trialNum);
